...
The check plug-ins can only be imported inside a Checkmk site. This module
reproduces the parts of the API the plug-ins use, *including its validation
rules*, so the check functions can be run here.
